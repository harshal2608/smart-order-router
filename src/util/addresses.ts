...
import { FACTORY_ADDRESS } from '@vnaysn/jediswap-sdk-v3';
...
export const V3_CORE_FACTORY_ADDRESSES: AddressMap = {
  ...constructSameAddressMap(FACTORY_ADDRESS as any),
...
export const SWAP_ROUTER_02_ADDRESSES= (chainId: ChainId): string => {
  return SWAP_ROUTER_ADDRESS_V2[chainId] ?? '0x0359550b990167afd6635fa574f3bdadd83cb51850e1d00061fe693158c23f80';
};
...
export type AddressMap = { [chainId: string]: string | undefined };
